"""
An entry with a right click!

-----------

Classes list:

- EntryWithRightClick(ttk.Combobox).__init__(self, master, *args, **kwargs):
...
class EntryWithRightClick(ttk.Entry):
    """
    A ttk.Entry, but with a right click!
    """
    ...
    def initiate_right_click_menu(self, disable: list = [], callback: Callable = None):
        def initiate_right_click_menu(self, disable: list = [], callback: Callable = None) -> None:
            """
