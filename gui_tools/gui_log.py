...
class Logger(logging.Handler):
    """
    A tk.Tk that acts as a logging.Handler.
    """
    ...
    def make_autoscroll_widgets(self) -> None:
        """
        Make the autoscroll widgets involved.
    ...
    def validate_for_number(self, new: str) -> bool:
        ...
        :param new: A string that you want to check.
        :return: Whether the string passes validation.
        """
        return new.isdigit()
    ...
    def save_scrollback(self) -> None:
        """
        Remember the scrollback.
    ...
    def make_scrollback_widgets(self) -> None:
        """
        Make the widgets involved with scrollback.
    ...
    def emit(self, record) -> None:
        ...
        :param record: Something that logging uses to transfer messages.
        :return: None.
        """
        self.log.config(state=tk.NORMAL)
